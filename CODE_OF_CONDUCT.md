...
**LingShu · 灵枢** community a harassment-free experience for everyone,
...
- 📜 Following the maintainers' guidance when in doubt
...
- 🚫 Spamming issues/PRs, drive-by low-effort reviews
...
- Ban temporarily or permanently any contributor for behaviors that they deem
  inappropriate, threatening, offensive, or harmful
- Communicate reasons for moderation decisions when appropriate

## Scope

This Code of Conduct applies within all community spaces — GitHub repos, the
Discord server, group chats, video calls, and any future venue. It also applies
when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the maintainers team at:

- **Email**: conduct@lingshu.ai *(set up at org launch)*
- **GitHub**: open a [private security/administrative issue](https://github.com/lingshu-ai-agent/.github/issues/new?labels=conduct&template=conduct_report.yml)
  on the `.github` repo (visible only to maintainers)
...
Code of Conduct, is allowed during this ban. Violating these terms may lead to
a permanent ban.
...
<sub align="center">Built with 🪷 by the LingShu community · 灵枢开源</sub>